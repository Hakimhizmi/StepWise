        ...
        >
            <View className="bg-white w-full min-h-[20vh] rounded-t-[30px]">
                ...
                <View className="px-5 py-8">
                    ...
                    </View> : <TouchableOpacity onPress={pickImage} className="mt-3 flex flex-row space-x-2 items-center justify-center px-8  py-3 bg-gray-100 border border-black/50 rounded-xl">
                        <Entypo name="images" size={24} color="black" />
