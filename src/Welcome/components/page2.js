...
export default function Page2({ navigation }) {
  ...
  return (
    <SafeAreaView className="h-screen flex justify-start py-5 relative bg-black">
      <View className='px-5 py-5'>
        <Text className="text-6xl text-white font-light">How StepWise Works</Text>
        <Text className="text-white text-xs px-3 font-extralight">
      ...
      <View className="mt-2 flex items-center justify-center">
        <Ionicons name="footsteps-outline" size={70} color="white" />
        </View>
